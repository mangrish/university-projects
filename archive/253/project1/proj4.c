...
/********************************/
{
    ...
    qsort(array,asize, sizeof(Struct_element),(int (*) (const void *, const void *))cmp);
		print_array(array,asize,filearray,size);
	}
...
/*
**	cmp: the cmp function for qsot, uses lib function strcasecmp to compare.
*/
