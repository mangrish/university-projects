...
void	scan_init(int startup, int pertrack, int disk_size, 
		int cache_size, double penalty, int disk_head);
...
void	scan_request(int proc, int track, ReadOrWrite type);
void	scan_schedule(int current_time, int *delay, int *nextproc);
